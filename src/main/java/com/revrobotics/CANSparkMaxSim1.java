...
public class CANSparkMaxSim1 {
  ...
  private final FlywheelSim m_simulatedDynamics;
   ...
   * at all.
   */
  private final int kAPIversionExpected = 132514050;
   ...
   *     constructor.
   */
  public CANSparkMaxSim1(CANSparkMax sparkMax, FlywheelSim dynamicsSim) {
  ...
  public CANSparkMaxSim1(CANSparkMax sparkMax) {
    this(sparkMax, new FlywheelSim(DCMotor.getNEO(1), 1.0, 0.00003973));
  }
  ...
  public void iterate(double velocity, double vbus, double dt) {
    ...
    // TODO: This doesn't work with the 2021 SPARK MAX API (works in 2022 though?)
